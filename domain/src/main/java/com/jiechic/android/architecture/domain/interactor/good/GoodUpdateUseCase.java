 ...
 */
public class GoodUpdateUseCase extends UseCase{
    ...
    //使用注入，自动生成该UseCase
    @Inject
    protected GoodUpdateUseCase(DataRepository dataRepository,ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    protected Observable buildUseCaseObservable() {
        return dataRepository.goodUpdate(this.good);
    }
